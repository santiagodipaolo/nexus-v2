    ...
    return (
      <div className="text-black mt-14">
        <section className="flex flex-col items-center justify-center text-center m-auto px-4 py-2">
          ...
          <a href="https://quote.nexus.lat" target="_blank" className="hover:pointer mt-6 p-2 text-white rounded-sm text-sm font-bold bg-green-500 my-2 mx-2 hover:bg-green-600">REQUEST A QUOTE</a>
        </section>
