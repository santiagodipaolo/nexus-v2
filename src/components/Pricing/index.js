export const Pricing = () => {
    return (
        <div id="pricing" className="flex flex-col justify-center items-center bg-[url('/faq-bg.png')] w-full xs:h-[1500px] lg:h-[800px] xl:h-[610px]">
          <section id="how-it-works" x-data="{annual: false}">
                ...
                <div className="text-center">
                  ...
                  <div className="grid grid-cols-1 gap-6 mt-10 lg:grid-cols-3">
                    ...
                    <div className="flex flex-col justify-between">
                      <div className="p-2 overflow-hidden border rounded-3xl">
                        <div className="h-[207px] p-8 bg-white border rounded-2xl lg:p-10">
                          <div>
