            ...
            {isOpen && (
                <div className="z-10 border rounded-md absolute bg-[#f5ede5] top-0 right-0 left-0 h-screen p-10 max-h-[750px] border-b border-gray-700">
                  ...
                  <ul className="flex flex-col flex-start items-left mt-16 space-y-12 text-xl">
                    ...
                    <div className="flex justify-between">
                      <a href="https://careers.nexus.lat" target='_blank' onClick={toggleMenu} className="text-gray-700">Careers</a>
                      <IoIosArrowForward className="text-gray-700 mt-1"/>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      <Link href="/blog" onClick={toggleMenu} className="text-gray-700">Blog</Link>
                      <IoIosArrowForward className="text-gray-700 mt-1"/>
                    </div>
                  </ul>
                  ...
                  <div className="text-center mt-8">
                    <a href="https://quote.nexus.lat" target="_blank" className="hover:pointer mt-6 p-3 text-white rounded-sm text-lg font-bold bg-green-500 my-2 mx-2 hover:bg-green-600">REQUEST A QUOTE</a>
                  </div>
                </div>
            )}
        </div>
